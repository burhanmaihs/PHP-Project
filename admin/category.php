									...
									<tbody>
                         				...
                         				while ($row = mysqli_fetch_assoc($result)) {
                         					...
                         					<tr>
										        ...
										        <td>
										        	<!-- edit button -->
										        	<a href="category.php?editId=<?php echo $cat_id;?>"><i class="fa fa-edit" style="color: blue"></i></a>
										        	<!-- delete button -->
										        	<a href="category.php?deleteId=<?php echo $cat_id;?>"><i class="fa fa-trash" style="color: blue"></i></a>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card mb-4">
                                	...
                                	<form method="POST">
                                		...
                                		<input type="submit" class="btn btn-md btn-success" name="submit" value="Confirm">
                	...
                	while ($row = mysqli_fetch_assoc($result)) {
               		 ...
               		 <div class="card">
               		 	...
               		 	<div class="card-body">
                        		...
                        		<input type="submit" class="btn btn-md btn-success" name="edit" value="Confirm">
